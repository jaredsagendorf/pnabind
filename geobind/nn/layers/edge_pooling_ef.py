...
class EdgePooling_EF(EdgePooling):
    def __init__(self, in_channels, dim, edge_score_method=None, dropout=0,
        ...
        self.dim = dim # dimension of edge features
        self.lin = torch.nn.Linear(2*in_channels + dim, 1)
