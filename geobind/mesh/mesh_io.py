...
def loadMesh(fileName, smoothing=None, process=True, **kwargs):
    
    mesh = trimesh.load(fileName, process=process, **kwargs)
    
    # check for multiple components, some meshes may have small disconnected regions
